...
def densenet161_model(img_rows, img_cols, channels=1, nb_dense_block=4, growth_rate=48,
             nb_filter=96, reduction=0.0, dropout_rate=0.0,
             weight_decay=1e-4, num_classes=None, use_pretraining=True,
