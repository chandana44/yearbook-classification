...
class YearbookModel:
    ...
    def __init__(self):
        ...
        self.get_model_function[KERAS_RESNET50_ARCHITECTURE] = self.getKerasResNet50
    ...
    def getVGG19(self, train_images, train_labels, load_saved_model,
        ...
        if load_saved_model:
            ...
            model = vgg19_model(img_rows=img_rows, img_cols=img_cols, channels=channels,
                                num_classes=NUM_CLASSES_YEARBOOK,
                                use_pretraining=use_pretraining, pretrained_weights_path=pretrained_weights_path,
                                optimizer=optimizer, loss=loss, fine_tuning_method=fine_tuning_method)
    ...
    def getResNet50(self, train_images, train_labels, load_saved_model,
        ...
        if load_saved_model:
            ...
            model = resnet50_model(img_rows, img_cols, channels, NUM_CLASSES_YEARBOOK, use_pretraining,
                                   pretrained_weights_path,
                                   fine_tuning_method, optimizer, loss)
    ...
    def getKerasResNet50(self, train_images, train_labels, load_saved_model,
        ...
        """
        print(get_time_string() + 'Creating Keras ResNet50 model..')
        ...
        for e in range(initial_epoch, num_epochs):
            ...
            if e % 3 == 0:
                print(get_time_string() + 'Epoch ' + str(e) + ' complete. Evaluating on validation set..')
                evaluateYearbookFromModel(model=model, architecture=KERAS_RESNET50_ARCHITECTURE, sample=sample)
